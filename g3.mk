...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native-caf/data/etc/android.hardware.sensor.barometer.xml:system/etc/permissions/android.hardware.sensor.barometer.xml \
...
$(call inherit-product-if-exists, frameworks/native-caf/build/phone-xxxhdpi-3072-hwui-memory.mk)
